...
--
-- Table structure for table `scenariographdag`
--

DROP TABLE IF EXISTS `scenariographdag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `scenariographdag` (
  `graph_id` varchar(32) NOT NULL,
  `graph_raw` longtext NOT NULL,
  `vertex_num` int(11) NOT NULL,
  `edge_num` int(11) NOT NULL,
...
-- Dump completed on 2017-02-20 13:37:00
