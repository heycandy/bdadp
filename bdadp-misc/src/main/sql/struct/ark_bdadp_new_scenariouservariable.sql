...
--
-- Table structure for table `scenariouservariable`
--

DROP TABLE IF EXISTS `scenariouservariable`;
...
CREATE TABLE `scenariouservariable` (
  ...
  `variable_expr` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2017-02-20 13:37:01
