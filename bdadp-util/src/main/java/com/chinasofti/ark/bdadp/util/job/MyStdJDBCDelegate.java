...
/**
 * <p> This is meant to be an abstract base class for most, if not all, <code>{@link
 * org.quartz.impl.jdbcjobstore.DriverDelegate}</code> implementations. Subclasses should override
 * only those methods that need special handling for the DBMS driver in question. </p>
 *
 * @author <a href="mailto:jeff@binaryfeed.org">Jeffrey Wescott</a>
 * @author James House
 * @author Eric Mueller
 */
public class MyStdJDBCDelegate implements DriverDelegate, StdJDBCConstants {
    ...
    protected List<TriggerPersistenceDelegate>
            ...
            new LinkedList<TriggerPersistenceDelegate>();
    ...
    /**
     * <p> Create new StdJDBCDelegate instance. </p>
     */
    public void StdJDBCDelegate() {
    }
                ...
                for (String trigDelClassName : trigDelegates) {
                    try {
                        ...
                        throw new NoSuchDelegateException(
                                "Error instantiating TriggerPersistenceDelegate of type: " + trigDelClassName, e);
                    }
                }
            } else {
    ...
    public void addTriggerPersistenceDelegate(TriggerPersistenceDelegate delegate) {
        logger.debug(
                "Adding TriggerPersistenceDelegate of type: " + delegate.getClass().getCanonicalName());
    ...
    /**
     * <p> Get the names of all of the triggers that have misfired. </p>
     *
     * @param conn the DB Connection
    ...
    /**
     * <p> Get the names of all of the triggers in the given state that have misfired - according to
     * the given timestamp.  No more than count will be returned. </p>
     *
     * @param conn       The DB Connection
     * @param count      The most misfired triggers to return, negative for all
     * @param resultList Output parameter.  A List of <code>{@link org.quartz.utils.Key}</code>
     *                   objects.  Must not be null.
     * @return Whether there are more misfired triggers left to find beyond the given count.
     */
    ...
    /**
     * <p> Get the number of triggers in the given states that have misfired - according to the given
     * timestamp. </p>
     *
     * @param conn the DB Connection
     */
    ...
    /**
     * <p> Get the names of all of the triggers in the given group and state that have misfired. </p>
     *
     * @param conn the DB Connection
     * @return an array of <code>{@link org.quartz.utils.Key}</code> objects
     */
    ...
    /**
     * <p> Select all of the triggers for jobs that are requesting recovery. The returned trigger
     * objects will have unique "recoverXXX" trigger names and will be in the <code>{@link
     * org.quartz.Scheduler}.DEFAULT_RECOVERY_GROUP</code> trigger group. </p>
     * <p>
     * <p> In order to preserve the ordering of the triggers, the fire time will be set from the
     * <code>COL_FIRED_TIME</code> column in the <code>TABLE_FIRED_TRIGGERS</code> table. The caller
     * is responsible for calling <code>computeFirstFireTime</code> on each returned trigger. It is
     * also up to the caller to insert the returned triggers to ensure that they are fired. </p>
     *
     * @param conn the DB Connection
    ...
    /**
     * <p> Get the names of all of the triggers associated with the given job. </p>
     *
     * @param conn the DB Connection
     * @return an array of <code>{@link org.quartz.utils.Key}</code> objects
     */
    ...
    /**
     * <p> Delete the job detail record for the given job. </p>
     *
     * @param conn the DB Connection
     * @return the number of rows deleted
     */
    ...
    /**
     * <p> Check whether or not the given job is stateful. </p>
     *
     * @param conn the DB Connection
    ...
    /**
     * <p> Check whether or not the given job exists. </p>
     *
     * @param conn the DB Connection
    ...
    /**
     * <p> Select the JobDetail object for a given job name / group name. </p>
     *
     * @param conn the DB Connection
    ...
    /**
     * <p> Select the total number of jobs stored. </p>
     *
     * @param conn the DB Connection
    ...
    /**
     * <p> Select all of the job group names that are stored. </p>
     *
     * @param conn the DB Connection
        ...
        switch (matcher.getCompareWithOperator()) {
            ...
            default:
                throw new UnsupportedOperationException(
                        "Don't know how to translate " + matcher.getCompareWithOperator() + " into SQL");
        }
        return groupName;
    }

    /**
     * <p> Insert the base trigger data. </p>
     *
     * @param conn    the DB Connection
    ...
    /**
     * <p> Insert the blob trigger data. </p>
     *
     * @param conn    the DB Connection
     * @param trigger the trigger to insert
     * @return the number of rows inserted
    ...
    /**
     * <p> Update the base trigger data. </p>
     *
     * @param conn    the DB Connection
     * @param trigger the trigger to insert
     * @param state   the state that the trigger should be stored in
    ...
    /**
     * <p> Update the blob trigger data. </p>
     *
     * @param conn    the DB Connection
     * @param trigger the trigger to insert
     * @return the number of rows updated
    ...
    /**
     * <p> Check whether or not a trigger exists. </p>
     *
     * @param conn the DB Connection
    ...
    /**
     * <p> Update the state for a given trigger. </p>
     *
     * @param conn  the DB Connection
    ...
    /**
     * <p> Update the given trigger to the given new state, if it is one of the given old states.
     * </p>
     *
     * @param conn      the DB connection
    ...
    public int updateTriggerStateFromOtherStates(Connection conn,
                                                 TriggerKey triggerKey, String newState,
                                                 String oldState1,
    ...
    /**
     * <p> Update all triggers in the given group to the given new state, if they are in one of the
     * given old states. </p>
     *
     * @param conn      the DB connection
    ...
    public int updateTriggerGroupStateFromOtherStates(Connection conn,
                                                      ...
                                                      String newState, String oldState1,
                                                      String oldState2, String oldState3)
            throws SQLException {
        PreparedStatement ps = null;
    ...
    /**
     * <p> Update the given trigger to the given new state, if it is in the given old state. </p>
     *
     * @param conn     the DB connection
     * @param newState the new state for the trigger
    ...
    /**
     * <p> Update all of the triggers of the given group to the given new state, if they are in the
     * given old state. </p>
     *
     * @param conn     the DB connection
     * @param matcher  the groupMatcher to evaluate the triggers against
    ...
    /**
     * <p> Delete the cron trigger data for a trigger. </p>
     *
     * @param conn the DB Connection
     * @return the number of rows deleted
     */
    ...
    /**
     * <p> Delete the base trigger data for a trigger. </p>
     *
     * @param conn the DB Connection
     * @return the number of rows deleted
     */
...
//            return result;
    ...
    /**
     * <p> Select the number of triggers associated with a given job. </p>
     *
     * @param conn the DB Connection
    ...
    /**
     * <p> Select the job to which the trigger is associated. </p>
     *
     * @param conn the DB Connection
    ...
    /**
     * <p> Select the job to which the trigger is associated. Allow option to load actual job class or
     * not. When case of remove, we do not need to load the class, which in many cases, it's no longer
     * exists.
     * <p>
     * </p>
     *
     ...
     */
    public JobDetail selectJobForTrigger(Connection conn, ClassLoadHelper loadHelper,
                                         TriggerKey triggerKey, boolean loadJobClass)
            throws ClassNotFoundException, SQLException {
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    /**
     * <p> Select the triggers for a job </p>
     *
     * @param conn the DB Connection
     * @return an array of <code>(@link org.quartz.Trigger)</code> objects associated with a given
     * job.
     */
    public List<OperableTrigger> selectTriggersForJob(Connection conn, JobKey jobKey)
        ...
        try {
            ...
            while (rs.next()) {
                OperableTrigger
                        t =
                        selectTrigger(conn, triggerKey(rs.getString(COL_TRIGGER_NAME),
     ...
     * @return the <code>{@link org.quartz.JobDataMap}</code> of the Trigger, never null, but possibly
     * empty.
     */
    ...
    /**
     * <p> Select a trigger' state value. </p>
     *
     * @param conn the DB Connection
     * @return the <code>{@link org.quartz.Trigger}</code> object
     */
    ...
    /**
     * <p> Select a trigger' status (state & next fire time). </p>
     *
     * @param conn the DB Connection
    ...
    /**
     * <p> Select the total number of triggers stored. </p>
     *
     * @param conn the DB Connection
    ...
    /**
     * <p> Select all of the trigger group names that are stored. </p>
     *
     * @param conn the DB Connection
     * @return an array of <code>String</code> group names
     */
    ...
    /**
     * <p> Select all of the triggers contained in a given group. </p>
     *
     * @param conn    the DB Connection
    ...
    /**
     * <p> Check whether or not a calendar exists. </p>
     *
     * @param conn         the DB Connection
    ...
    /**
     * <p> Select all of the stored calendars. </p>
     *
     * @param conn the DB Connection
    ...
    /**
     * <p> Select the trigger that will be fired at the given fire time. </p>
     *
     * @param conn     the DB Connection
     * @param fireTime the time that the trigger will be fired
     * @return a <code>{@link org.quartz.utils.Key}</code> representing the trigger that will be fired
     * at the given fire time, or null if no trigger will be fired at that time
     */
    ...
    /**
     * <p> Select the next trigger which will fire to fire between the two given timestamps in
     * ascending order of fire time, and then descending by priority. </p>
     *
     * @param conn          the DB Connection
     * @param noLaterThan   highest value of <code>getNextFireTime()</code> of the triggers (exclusive)
     * @param noEarlierThan highest value of <code>getNextFireTime()</code> of the triggers
     *                      (inclusive)
     * @return A (never null, possibly empty) list of the identifiers (Key objects) of the next
     * triggers to be fired.
     * @deprecated - This remained for compatibility reason. Use {@link #selectTriggerToAcquire(Connection,
     ...
     */
    public List<TriggerKey> selectTriggerToAcquire(Connection conn, long noLaterThan,
                                                   long noEarlierThan, int maxCount)
            throws SQLException {
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    /**
     * <p> Select the states of all fired-trigger records for a given trigger, or trigger group if
     * trigger name is <code>null</code>. </p>
     *
    ...
    /**
     * <p> Select the states of all fired-trigger records for a given job, or job group if job name is
     * <code>null</code>. </p>
     *
     * @return a List of FiredTriggerRecord objects.
     */
    ...
    /**
     * <p> Select the distinct instance names of all fired-trigger records. </p>
     * <p>
     * <p> This is useful when trying to identify orphaned fired triggers (a fired trigger without a
     * scheduler state record.) </p>
     *
    ...
    /**
     * <p> Replace the table prefix in a query by replacing any occurrences of "{0}" with the table
     * prefix. </p>
     *
    ...
    /**
     * <p> Create a serialized <code>java.util.ByteArrayOutputStream</code> version of an Object.
     * </p>
     *
    ...
    /**
     * <p> Remove the transient data from and then create a serialized <code>java.util.ByteArrayOutputStream</code>
     * version of a <code>{@link org.quartz.JobDataMap}</code>. </p>
     *
     ...
     *
     * @return The key of the first non-serializable value in the given Map or null if all values are
     * serializable.
     */
    ...
    /**
     * <p> This method should be overridden by any delegate subclasses that need special handling for
    ...
    /**
     * <p> This method should be overridden by any delegate subclasses that need special handling for
     * BLOBs for job details. The default implementation uses standard JDBC <code>java.sql.Blob</code>
     * operations. </p>
     *
     * @param rs      the result set, already queued to the correct row
     * @param colName the column name for the BLOB
    ...
    /**
     * Sets the designated parameter to the given Java <code>boolean</code> value. This just wraps
     * <code>{@link PreparedStatement#setBoolean(int, boolean)}</code> by default, but it can be
     * overloaded by subclass delegates for databases that don't explicitly support the boolean type.
     */
    ...
    /**
     * Retrieves the value of the designated column in the current row as a <code>boolean</code>. This
     * just wraps <code>{@link ResultSet#getBoolean(java.lang.String)}</code> by default, but it can
     * be overloaded by subclass delegates for databases that don't explicitly support the boolean
     * type.
     */
     ...
     * <code>boolean</code>. This just wraps <code>{@link ResultSet#getBoolean(java.lang.String)}</code>
     * by default, but it can be overloaded by subclass delegates for databases that don't explicitly
    ...
    /**
     * Sets the designated parameter to the byte array of the given <code>ByteArrayOutputStream</code>.
     * Will set parameter value to null if the <code>ByteArrayOutputStream</code> is null. This just
     * wraps <code>{@link PreparedStatement#setBytes(int, byte[])}</code> by default, but it can be
     * overloaded by subclass delegates for databases that don't explicitly support storing bytes in
     * this way.
     */
