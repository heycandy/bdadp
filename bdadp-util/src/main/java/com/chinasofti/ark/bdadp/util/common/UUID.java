...
/**
 * Created by White on 2016/08/28.
 */
 ...
 * (UUID) URN Namespace</i></a>, section 4.2 &quot;Algorithms for Creating a Time-Based UUID&quot;.
 *
 * @since 1.5
 */
public final class UUID implements java.io.Serializable, Comparable<UUID> {
    ...
    /**
     * Constructs a new {@code UUID} using the specified data.  {@code mostSigBits} is used for the
     * most significant 64 bits of the {@code UUID} and {@code leastSigBits} becomes the least
     * significant 64 bits of the {@code UUID}.
     *
    ...
    /**
     * Static factory to retrieve a type 3 (name based) {@code UUID} based on the specified byte
     * array.
     *
     ...
     * <p>
     * The version number has the following meaning: <ul> <li>1    Time-based UUID <li>2    DCE
    ...
    /**
     * The variant number associated with this {@code UUID}.  The variant number describes the layout
     * of the {@code UUID}.
     * <p>
     * The variant number has the following meaning: <ul> <li>0    Reserved for NCS backward
     * compatibility <li>2    <a href="http://www.ietf.org/rfc/rfc4122.txt">IETF&nbsp;RFC&nbsp;4122</a>
     * (Leach-Salz), used by this class <li>6    Reserved, Microsoft Corporation backward
     * compatibility <li>7    Reserved for future definition </ul>
     *
     ...
     * of this {@code UUID}.  The resulting timestamp is measured in 100-nanosecond units since
     * midnight, October 15, 1582 UTC.
     * <p>
     * <p> The timestamp value is only meaningful in a time-based UUID, which has version type 1.  If
     * this {@code UUID} is not a time-based UUID then this method throws
     ...
     * <p>
     * <p> The 14 bit clock sequence value is constructed from the clock sequence field of this UUID.
     * The clock sequence field is used to guarantee temporal uniqueness in a time-based UUID.
     * <p>
     * <p> The {@code clockSequence} value is only meaningful in a time-based UUID, which has version
     ...
     * spatial uniqueness.
     * <p>
     * <p> The node value is only meaningful in a time-based UUID, which has version type 1.  If this
     ...
     * argument is not {@code null}, is a {@code UUID} object, has the same variant, and contains the
     * same value, bit for bit, as this {@code UUID}.
     *
