...
import com.chinasofti.ark.bdadp.util.dto.HttpContent;
...
public class HttpUtil {
    ...
    public static HttpContent get(String url) {
        ...
        try {
            ...
            HttpResponse chr = httpClient.execute(httpGet);
    ...
    public static HttpContent getHttpResponse(HttpResponse httpResponse) throws IOException {
