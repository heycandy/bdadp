...
public class SecurityLogin {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SecurityLogin.class);
    ...
    public synchronized static void login(String userPrincipal, String userKeytabPath,
                                          String krb5ConfPath, Configuration conf)
            throws IOException {
        ...
        // current user is not from keytab.
...
//        }
    ...
    public static void setJaasConf(String loginContextName, String principal, String keytabFile)
        ...
        javax.security.auth.login.Configuration
                .setConfiguration(new JaasConfiguration(loginContextName, principal,
        ...
        if (!checkPrincipal) {
            LOG.error(
                    "AppConfigurationEntry named " + loginContextName + " does not have principal value of "
                            + principal + ".");
        ...
        if (!checkKeytab) {
            LOG.error(
                    "AppConfigurationEntry named " + loginContextName + " does not have keyTab value of "
                            + keytabFile + ".");
            throw new IOException(
                    "AppConfigurationEntry named " + loginContextName + " does not have keyTab value of "
                            + keytabFile + ".");
