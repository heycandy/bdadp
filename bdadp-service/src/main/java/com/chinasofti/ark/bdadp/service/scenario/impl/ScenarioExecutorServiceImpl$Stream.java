...
import com.chinasofti.ark.bdadp.service.flow.bean.StreamCallableFlow;
...
/**
 * Created by White on 2016/11/28.
 */

public class ScenarioExecutorServiceImpl$Stream extends ScenarioExecutorServiceImpl$Channel {
  ...
  public String execute(ScenarioOptions options, Class<? extends Listener>[] listeners)
    ...
    CallableFlow flow = new StreamCallableFlow(options, graph);
